...
struct	ncp_header	{
	...
	unsigned	nh_time;	/* Last time packet was processed */
};
/*
...
#define pk_len		pk_phead.ph_lenfc.ph_lfcparts.ph_len
...
struct connection {
	...
	unsigned	cn_active;	/* Last time connection was active */
...
struct	chxcvr	{
	...
	unsigned 	xc_ttime;	/* Time tpkt begun transmission */
	unsigned	xc_rtime;	/* Time rpkt began reception */
...
#define CHCCOST		11	/* Chaos cable connection (ether) */
#define CHACOST		20	/* Async or other slow link */
#define CHHCOST		200	/* "high" cost */
...
EXTERN unsigned int		Chclock;  	/* clock (mod ??) */
