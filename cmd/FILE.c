 ...
 */
int parsepath(path, dir, real, blankok)
register char *path;
char **dir, **real;
int blankok;
{
 ...
 */
int fherror(f, code, type, message)
register struct file_handle *f;
int code;
int type;
char *message;
