...
/*
 * RCS Info	
 *	$Header: /home/ams/c-rcs/chaos-2000-07-03/kernel/h/old/proc.h,v 1.1.1.1 1998/09/07 18:56:09 brad Exp $
 *	$Locker:  $
 */
...
struct	proc {
	...
	struct	proc *p_tptr;	/* pointer to process tracing this one */
 ...
 */
#define SSHMEM	0x02000000	/* process has shared memory attached */
/* #endif WISC_SHMEM */
#define SREMOTE	0x08000000	/* RFS activity has occurred in this process */
#define SNOREMOTE 0x10000000	/* Disallow RFS access in this process */

/*
 * Local (MIT LCS)
 */
#define	STRACNG	0x20000000	/* process is tracing another process */
