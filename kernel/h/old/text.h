...
/*
 * RCS Info	
 *	$Header: /home/ams/c-rcs/chaos-2000-07-03/kernel/h/old/text.h,v 1.1.1.1 1998/09/07 18:56:10 brad Exp $
 *	$Locker:  $
 */

/*
  Include time.h here so that the addition of the x_vers field
  of the text structure does not entail explicit inclusion of time.h
  in all the files that include text.h. Not Berkeley, but Berkeley is
  wrong.
*/
...
struct text
{
	...
	struct timeval x_vers;	/* time on proto vnode text segment */
				/* was created */
};
