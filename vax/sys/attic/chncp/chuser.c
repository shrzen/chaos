/*
 *	$Source: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chuser.c,v $
 *	$Author: cfields $
 *	$Locker:  $
 *	$Log: chuser.c,v $
 ...
 */
#ifndef lint
static char *rcsid_chuser_c = "$Header: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chuser.c,v 1.1 1994/09/16 11:06:29 cfields Exp $";
#endif lint
#include "../h/chaos.h"
