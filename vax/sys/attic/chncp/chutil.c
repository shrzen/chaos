/*
 *	$Source: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chutil.c,v $
 *	$Author: cfields $
 *	$Locker:  $
 *	$Log: chutil.c,v $
 * Revision 1.1  1994/09/16  11:06:30  cfields
 * Initial revision
 *
 * Revision 1.1  84/06/12  20:27:23  jis
 * Initial revision
 * 
 */
#ifndef lint
static char *rcsid_chutil_c = "$Header: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chutil.c,v 1.1 1994/09/16 11:06:30 cfields Exp $";
#endif lint
#include "../h/chaos.h"
