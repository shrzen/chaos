/*
 *	$Source: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chil.c,v $
 *	$Author: cfields $
 *	$Locker:  $
 *	$Log: chil.c,v $
 * Revision 1.1  1994/09/16  11:06:27  cfields
 * Initial revision
 *
 ...
 */
#ifndef lint
static char *rcsid_chil_c = "$Header: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chil.c,v 1.1 1994/09/16 11:06:27 cfields Exp $";
#endif lint
#include "../h/chaos.h"
