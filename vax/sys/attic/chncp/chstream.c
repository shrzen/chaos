/*
 *	$Source: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chstream.c,v $
 *	$Author: cfields $
 *	$Locker:  $
 *	$Log: chstream.c,v $
 * Revision 1.1  1994/09/16  11:06:29  cfields
 * Initial revision
 *
 ...
 */
#ifndef lint
static char *rcsid_chstream_c = "$Header: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chstream.c,v 1.1 1994/09/16 11:06:29 cfields Exp $";
#endif lint
#include "../h/chaos.h"
