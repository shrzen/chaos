/*
 *	$Source: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chrcv.c,v $
 *	$Author: cfields $
 *	$Locker:  $
 *	$Log: chrcv.c,v $
 * Revision 1.1  1994/09/16  11:06:26  cfields
 * Initial revision
 *
 * Revision 1.2  85/09/07  15:38:13  root
 * Removed chipinput routine.
 * 
 * Revision 1.1  84/06/12  20:27:14  jis
 * Initial revision
 * 
 */
#ifndef lint
static char *rcsid_chrcv_c = "$Header: /afs/dev.mit.edu/source/src77/bsd-4.3/vax/sys/attic/chncp/RCS/chrcv.c,v 1.1 1994/09/16 11:06:26 cfields Exp $";
#endif lint
#include "../h/chaos.h"
...
register struct connection *conn;
{
	...
	conn->cn_laddr = rfcpkt->pk_daddr ? rfcpkt->pk_daddr : Chmyaddr;
	/*
