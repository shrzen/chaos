/*
 *	$Source: /source/bsd-4.3/vax/sys/chncp/chncp.h,v $
 *	$Author: probe $
 *	$Locker:  $
 *	$Log:	chncp.h,v $
 * Revision 1.2  90/07/17  13:28:49  probe
 * changes.71#1024 - ANSI compliance - #endif comments should be in /* */
 * 
 * Revision 1.1  90/07/17  11:06:10  probe
 * Initial revision
 * 
...
struct	chxcvr	{
	...
	int		(*xc_xmit)();	/* Transmit a packet (xcvr, pkt, at-head-p) */
